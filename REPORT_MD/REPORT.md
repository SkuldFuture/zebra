# Отчёт: Поиск оптимального метода разбиения видео для распознавания блюд

## Оглавление
1. [Поиск оптимального метода разбиения видео](#№поиск-оптимального-метода-разбиения-видео)
2. [Аугментация](#№аугментация)
---
